-- TODO: move configuration to separate files to keep this file readable and maintainable
...
require('lazy').setup({
...

  {
    ...
    opts = {
      ...
      scope = {
        enabled = false, -- disable underline for marking outer scope
      },
    },
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', builtin.live_grep, { desc = '[S]earch by [G]rep' }) -- NOTE: This requires ripgrep to be installed
      vim.keymap.set('n', '<leader>sd', function()
        builtin.diagnostics { previewer = false, line_width = 200 }
